...
void red_ring_side() {
  ...
  LadyBrown.move_absolute(1693.3118, 15000);
  chassis.pid_wait();
  pros::delay(1000);
  ...
  pros::delay(100);
  chassis.pid_wait();
  chassis.pid_turn_set(110_deg, 100);
  chassis.pid_wait();
  chassis.pid_drive_set(27_in,80);
  chassis.pid_wait();
  chassis.pid_turn_set(-130_deg, 100);
  chassis.pid_wait();
  ...
  pros::delay(100);
  chassis.pid_drive_set(36_in, 100);
  LadyBrown.move_absolute(394.7122, 500);
}
...
void red_goal_rush() {
  chassis.pid_drive_set(-45.5_in, 127);
  chassis.pid_wait();
...
void skills() {
  ...
  chassis.pid_wait();
  pros::delay(10);
  chassis.pid_drive_set(12_in, 78);
  chassis.pid_wait();
  chassis.pid_turn_set(135_deg, 80);
  chassis.pid_wait();
  chassis.pid_drive_set(16.97_in, 78);
  chassis.pid_wait();
  chassis.pid_turn_set(-153.435_deg, 80);
  chassis.pid_wait();
  chassis.pid_drive_set(-26.8_in, 80);
  chassis.pid_wait();
  Clamp.set_value(0);
  pros::delay(10);
  // 2nd Goal Fill
/*  chassis.pid_drive_set(13.8_in, 100);
  ...
  chassis.pid_wait();
  chassis.pid_drive_set(-81_in, 100);
  chassis.pid_wait();
  Clamp.set_value(1);
  ...
  chassis.pid_drive_set(24_in, 100);
  chassis.pid_wait();
  chassis.pid_turn_set(-153.435_deg, 90);
  chassis.pid_wait();
  chassis.pid_drive_set(25.8328_in, 100);
  chassis.pid_wait();
  ...
  chassis.pid_drive_set(12_in, 100);
  chassis.pid_wait();
  chassis.pid_turn_set(126.935_deg, 90);
  chassis.pid_wait();
  ...
  // 3rd Corner Place
  Intake.brake();
  chassis.pid_drive_set(16.7_in, 100);
  chassis.pid_wait();
  chassis.pid_turn_set(0_deg, 90);
  chassis.pid_wait();
  chassis.pid_drive_set(-60_in, 100);
  chassis.pid_wait();
  chassis.pid_turn_set(-21.8_deg, 90);
  chassis.pid_wait();
  chassis.pid_drive_set(64.62_in, 100);
  chassis.pid_wait();
  Clamp.set_value(1);
  chassis.pid_turn_set(104_deg, 90);
  chassis.pid_wait();
  chassis.pid_drive_set(-49.477_in, 100);
  chassis.pid_wait();
  Clamp.set_value(0);
  pros::delay(10);
  // Last Goal
  Intake.move(127);
  chassis.pid_drive_set(39.377_in, 100);
  chassis.pid_wait();
  chassis.pid_turn_set(-116.565_deg, 90);
  chassis.pid_wait();
  chassis.pid_drive_set(26.8328_in, 100);
  chassis.pid_wait();
  Clamp.set_value(1);
  ...
  chassis.pid_turn_set(180_deg, 90);
  chassis.pid_wait();
  chassis.pid_drive_set(47.9_in, 100);
  chassis.pid_wait();
  chassis.pid_turn_set(90_deg, 100);
  chassis.pid_wait();
  Intake.brake();
  ...
  chassis.pid_turn_set(-45_deg, 100);
  chassis.pid_wait();
  chassis.pid_drive_set(16.97_in, 88);
  chassis.pid_wait();
  chassis.pid_turn_set(18.435_deg, 100);
  chassis.pid_wait();
  ...
  // Goal 3
  chassis.pid_drive_set(7.8_in, 100);
  chassis.pid_wait();
  chassis.pid_turn_set(-71.565_deg, 100);
  chassis.pid_wait();
  ...
  chassis.pid_wait();
  chassis.pid_drive_set(16.97056_in, 88);
  chassis.pid_wait();
